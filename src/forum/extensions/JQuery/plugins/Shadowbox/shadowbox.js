...
jQuery(document).ready(function($){ // allows compatibility with prototype and other libraries
	var pathTo_JQueryPluginShadowbox = Vanilla.webRoot+'extensions/JQuery/plugins/shadowbox/';
	var options = {
		loadingImage:		pathTo_JQueryPluginShadowbox+'images/loading.gif',
		overlayBgImage:		pathTo_JQueryPluginShadowbox+'images/overlay-85.png',
		resizeLgImages:     true,
