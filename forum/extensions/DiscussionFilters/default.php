...
$Context->SetDefinition('DiscussionFilters', 'Affiner');
$Context->SetDefinition('BookmarkedDiscussions', 'Discussions suivies');
$Context->SetDefinition('YourDiscussions', 'Discussions auquelles vous avez participé');
