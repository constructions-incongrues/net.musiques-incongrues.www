...
<p style="text-align:center;"><a href="<?php echo sprintf('http://zeitgeist.musiques-incongrues.net/%s', $idLastZeitgeist) ?>">Un résumé hebdomadaire de l'activité du forum des Musiques Incongrues</a></p>
