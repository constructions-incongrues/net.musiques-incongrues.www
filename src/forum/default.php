...
$MetaTags->AddData('keywords', 'musiques incongrues, ego twister, da ! heard it records, ouïedire, renardo krew, the brain, musique approximative,  musiques éclectiques, 8bit, breakcore, electro punk, agenda, calendrier, radio, expositions de dessin, netlabel, ');
...
if($Context->SelfUrl == 'comments.php') {
  ...
  $MetaTags->AddData('description', 'Musiques Incongrues est un forum abordant les musiques éclectiques, expositions de dessin, etc. ');
}
